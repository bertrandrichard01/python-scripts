...
def add_data(bd,gps,gps_value_fld,id_fld):
    """
    INPUTS:
                bd              - database polygon shapefile
                gps             - gps points shapefile
                gps_value_fld   - name of the field wich contains nomenclature codes in gps points shapefile
                id_fld          - name of the field wich contains the ID in database polygon shapefile
